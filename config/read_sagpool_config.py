...
# -*- coding: UTF-8 -*-
'''=================================================
@Project -> File   ：GraphTools -> read_sagpool_config
@IDE    ：PyCharm
@Author ：pengchenghu
...
# 获取config.ini的路径
config_path = os.path.join(cur_path, 'sagpool_config.ini')
...
n_node = conf.get('model', 'n_node').strip().split(',')  # 池化节点数目
n_node = [int(unit) for unit in n_node]
